	...
	namespace LoadBalancing
	{
		...
		OperationRequestParameters Peer::enterRoomImplementation(const RoomOptions* pOptions, const Hashtable& customLocalPlayerProperties, const JVector<JString>& expectedUsers)
		{
			...
			if(pOptions)
			{
				...
				// intentionally sending the array even when it is empty, as not sending the parameter at all means "list all properties in the lobby", while an empty array means "don't list any proeprties in the lobby"
